...
const OPEN_ROLES = [
  {
    ...
    description: "Design federated review pipelines, optimize model routing algorithms, and implement fallback continuity across asynchronous multi-agent workflows.",
    requirements: [
      "5+ years of experience with distributed systems, low-latency microservices, and system-level TypeScript/Node.js or Rust.",
      "Hands-on experience implementing multi-agent consensus protocols, quorum gating, and fallback architectures in production.",
      "Strong background in API resiliency, latency budgeting, and memory boundary optimization."
    ]
  },
  {
    id: "adversarial-eval-eng",
    title: "Adversarial Evaluation Engineer",
    department: "Vulnerability & Hallucination Labs",
    location: "Remote (Pittsburgh)",
    type: "Full-Time",
    description: "Build automated adversarial testing frameworks to systematically stress-test reasoning chains, surface contradictions, and detect unverified assumptions across frontier models.",
    requirements: [
      "Demonstrated experience designing structured red-teaming benchmarks, cognitive probing suites, and logical deduction tracking.",
      "Background in natural language processing (NLP), evaluation harnesses, or security penetration testing.",
      "Proven ability to systematize unstructured model failure modes into reproducible regression benchmarks."
    ]
  },
  {
    id: "security-gov-arch",
    ...
    description: "Develop policy enforcement engines, evidence provenance logging, and zero-retention verification pipelines for enterprise customer deployments.",
    requirements: [
      "Extensive background in data sanitization vaults, TLS proxy tunneling, and cryptographic verification metadata.",
      "Experience auditing enterprise security architectures, SOC 2 compliance, and zero-data-retention environments.",
      "Track record of shipping verifiable policy-gating systems for high-consequence agent workflows."
    ]
  }
];
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 py-12 sm:py-24">
        ...
        <div className="max-w-3xl mb-16">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-indigo-50 border border-indigo-100 mb-6">
            ...
            <span className="text-[10px] uppercase tracking-[0.2em] font-black text-indigo-700">Engineering Pipeline</span>
          </div>
          <h1 className="text-5xl sm:text-6xl font-sans font-black tracking-tight uppercase leading-[0.95] mb-8">
            ...
            <span className="text-indigo-600">that makes AI actions accountable.</span>
          </h1>
          <p className="text-lg sm:text-xl font-bold text-gray-700 leading-relaxed max-w-2xl">
            We are building the review, routing, and evidence systems that help autonomous software operate safely under uncertainty. The same underlying review capability is used by people in the Console and extended by developers into agent workflows.
          </p>
        </div>
