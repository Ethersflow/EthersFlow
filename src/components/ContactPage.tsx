      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 py-12 sm:py-24">
        ...
        <div className="max-w-2xl mb-16">
          ...
          <p className="text-lg sm:text-xl font-bold text-gray-700 leading-relaxed max-w-2xl">
            Have questions about our platform, enterprise features, or customized solutions? Connect with our team.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-7 bg-white border border-gray-150 rounded-[36px] p-8 sm:p-10 shadow-sm relative">
            <div className="mb-8">
              <h3 className="text-xs font-black uppercase tracking-[0.3em] text-indigo-700 mb-2">// COMMUNICATE WITH US</h3>
              <h2 className="text-3xl font-sans font-black uppercase text-gray-950">Secure Form</h2>
              <p className="text-xs font-semibold text-gray-550 leading-relaxed mt-2">
                Submit your inquiry below. All messages are securely routed directly to our operations team.
              </p>
            </div>
            ...
            {success ? (
              ...
              >
                ...
                <h4 className="text-lg font-black text-emerald-950 uppercase">Message Sent</h4>
                <p className="text-xs font-bold text-emerald-700/80 leading-relaxed mt-2 max-w-sm mx-auto">
                  Thank you! Your inquiry has been securely sent. A member of our team will review and reply within 12-24 business hours.
                </p>
                <button 
                  onClick={() => setSuccess(false)}
                  className="mt-6 text-xs text-indigo-600 font-bold uppercase tracking-wider hover:underline"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-[10px] font-black text-gray-700 uppercase tracking-widest mb-2">My Full Name</label>
                    <input 
                      type="text" 
                      required
                  ...
                  <div>
                    <label className="block text-[10px] font-black text-gray-700 uppercase tracking-widest mb-2">My Correspondence Email</label>
                    <input 
                      type="email" 
                      required
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-[10px] font-black text-gray-700 uppercase tracking-widest mb-2">Primary Inquiry Theme</label>
                    <select 
                    ...
                    >
                      ...
                      <option value="Press or Media Channel">Press or Media Channel</option>
                    </select>
                  </div>
                ...
                <div>
                  <label className="block text-[10px] font-black text-gray-700 uppercase tracking-widest mb-2">My Message Body</label>
                  <textarea 
                    required
                    rows={5}
