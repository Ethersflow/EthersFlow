...
const RESEARCH_PAPERS = [
  {
    ...
    citations: 1420,
    readTime: "12 mins",
    abstract: "This study systematically examines whether large language models can self-correct their own reasoning errors without external feedback. The analysis demonstrates that without external guidance, prompting a model to self-correct often fails or degrades performance, as the model converges on its inherent parametric biases. This establishes the practical necessity of external validation systems.",
    whatThisSupports: "Independent review across heterogeneous architectures can expose errors and blind spots that single-model self-correction routinely misses.",
    whatThisDoesNotProve: "Multi-agent review does not guarantee total correctness on novel, out-of-distribution reasoning without ground-truth facts."
  },
  {
    category: "External Research",
    ...
    citations: 890,
    readTime: "15 mins",
    abstract: "This paper introduces a multi-agent debate framework where multiple model instances propose and debate their individual answers over multiple rounds before arriving at a final consensus. Collaborative questioning substantially improves factuality, reasoning logic, and answer consistency on complex datasets.",
    whatThisSupports: "Structured adversarial cross-examination between diverse viewpoints surfaces factual errors and logical leaps prior to action.",
    whatThisDoesNotProve: "Does not prove that debate eliminates all systemic or shared training biases across foundational model providers."
  },
  {
    category: "External Research",
    ...
    whatThisSupports: "Game-theoretic signaling and equilibrium search provide structured mathematical mechanisms for evaluating disagreement.",
    whatThisDoesNotProve: "Equilibrium convergence is sensitive to prompt framing and cannot substitute for verified external citations."
  },
  {
    category: "External Research",
  ...
  {
    category: "EthersFlow Benchmarks",
    title: "EF-Bench 2026: Empirical Contradiction Detection in Simulated & Production Agent Tool Calls",
    source: "EthersFlow Empirical Benchmarks",
...
export function ResearchPage({ onClose }: ResearchPageProps) {
  ...
  const categories = ["All", "External Research", "EthersFlow Protocol Specification", "EthersFlow Benchmarks"];
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-12 sm:py-24">
        ...
        <div className="mb-20">
          ...
          <p className="text-lg sm:text-xl text-gray-300 max-w-3xl leading-relaxed font-sans mb-4">
            Studying how independent review can reduce single-model decision risk.
          </p>
          <p className="text-sm text-gray-400 max-w-3xl leading-relaxed font-sans">
            This work supports the premise that independent review can expose errors that single-model self-correction may miss. It does not by itself validate every implementation or deployment outcome.
          </p>
        </div>
                ...
                >
                  <div className="space-y-6">
                    ...
                    <div className="space-y-3">
                      <div className="bg-emerald-950/20 rounded-2xl p-4 border border-emerald-500/15">
                        <span className="text-[10px] font-mono font-black uppercase tracking-[0.12em] text-emerald-300 block mb-1">What this supports</span>
                        <p className="text-xs text-gray-300 leading-relaxed font-medium">
                          {paper.whatThisSupports}
                        </p>
                      </div>

                      <div className="bg-amber-950/20 rounded-2xl p-4 border border-amber-500/15">
                        <span className="text-[10px] font-mono font-black uppercase tracking-[0.12em] text-amber-300 block mb-1">What this does not prove</span>
                        <p className="text-xs text-gray-300 leading-relaxed font-medium">
                          {paper.whatThisDoesNotProve}
                        </p>
                      </div>
                    </div>
                  </div>
