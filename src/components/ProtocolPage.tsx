        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-24">
          <div className="lg:col-span-7">
            ...
            <p className="text-lg sm:text-xl font-bold text-gray-700 leading-relaxed max-w-2xl">
              EthersFlow operates on a zero-trust multi-model arbitration network. We force independent AI systems to cross-examine claims to eliminate parametric bias and synthetic hallucinations.
            </p>
          </div>
        ...
        <div className="border-t border-gray-200/60 pt-16 mb-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white border border-gray-150 p-8 rounded-[32px] hover:shadow-md transition-all">
              ...
              <h4 className="text-base font-black text-gray-950 uppercase mb-3 text-left">PII Tokenization</h4>
              <p className="text-xs font-semibold text-gray-500 leading-relaxed">
                Prior to outbound dispatch, sensitive credentials, keys, or names are swapped locally with dummy swap-tokens, defending absolute client privacy.
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-150 p-8 rounded-[32px] hover:shadow-md transition-all">
              ...
              <h4 className="text-base font-black text-gray-950 uppercase mb-3 text-left">Model Spawning</h4>
              <p className="text-xs font-semibold text-gray-500 leading-relaxed">
                The query spawns three distinct model architectures (e.g. mOE, Transformer, and Reasoning-Distilled) loaded with diverse specialized expert personas.
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-150 p-8 rounded-[32px] hover:shadow-md transition-all">
              ...
              <h4 className="text-base font-black text-gray-950 uppercase mb-3 text-left">Adversarial Debate</h4>
              <p className="text-xs font-semibold text-gray-500 leading-relaxed">
                Expert personas evaluate peer assertions, check supporting logic trees, detect contradictions, and probe potential hallucination triggers.
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-150 p-8 rounded-[32px] hover:shadow-md transition-all">
              ...
              <h4 className="text-base font-black text-gray-950 uppercase mb-3 text-left">Weighted Verdict</h4>
              <p className="text-xs font-semibold text-gray-500 leading-relaxed">
                Logic contradictions are mathematically penalized. The systems synthesize verified traces into a single vetted answer and compute a confidence score.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="lg:col-span-7 bg-[#1d1d1f] text-white p-8 sm:p-12 rounded-[40px] shadow-xl relative overflow-hidden">
            ...
            <div className="space-y-4">
              <div className="flex gap-3">
                ...
                <div>
                  <h5 className="text-xs font-black text-white uppercase">Self-Correction Elimination</h5>
                  <p className="text-xs text-gray-400 mt-1">Single-model self-correction loops often suffer from confirmation drift. Confronting models with divergent architectures mitigates this vulnerability completely.</p>
                </div>
              </div>
              <div className="flex gap-3">
                <CheckCircle2 className="w-5 h-5 text-emerald-400 shrink-0 mt-0.5" />
                <div>
                  <h5 className="text-xs font-black text-white uppercase">Provable Trace Audit Trails</h5>
                  <p className="text-xs text-gray-400 mt-1">Every dialectic step and contradiction flag remains permanently audited inside the safe local trace logic database for transparent compliance reviews.</p>
                </div>
              </div>
            </div>
          </div>
