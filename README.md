...
[![MCP Server](https://img.shields.io/badge/MCP_Server-npx_%40ethersflow%2Fmcp-blue.svg)](mcp/README.md)
...
|---|---|---|
| **MCP Server** | [`/mcp`](mcp/README.md) | `npx @ethersflow/mcp` for Claude Desktop, Cursor, and MCP clients |
