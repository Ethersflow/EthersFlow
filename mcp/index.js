#!/usr/bin/env node
/**
 * @ethersflow/mcp — Executable Model Context Protocol (MCP) Server
...
const ETHERSFLOW_API_URL = process.env.ETHERSFLOW_API_URL || "https://ethersflow-225907257236.us-east1.run.app";
const ETHERSFLOW_API_KEY = process.env.ETHERSFLOW_API_KEY || "ef_live_demo_key";
