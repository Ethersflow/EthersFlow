...
[![npm version](https://img.shields.io/npm/v/@ethersflow/mcp.svg)](https://www.npmjs.com/package/@ethersflow/mcp)
...
You can run `@ethersflow/mcp` instantly without local installation using `npx`:
